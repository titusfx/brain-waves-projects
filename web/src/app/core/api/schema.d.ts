...
export interface paths {
    ...
    "/api/recordings/{entry_id}": {
         ...
         * @description Remove a recording or dataset from ``recordings/``.
         *
         ...
         */
        delete: operations["delete_recording_api_recordings__entry_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/recordings/{entry_id}/discovery": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * What repeats within a state, and what separates two states
         * @description The Discovery screen's analysis, for one dataset and one channel.
         *
         ...
         */
        post: operations["discover_api_recordings__entry_id__discovery_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        ComparisonModel: {
            /** Bands */
            bands: components["schemas"]["BandEffectModel"][];
            /** Effect */
            effect: number[];
            /** Freqs */
            freqs: number[];
            ...
            n_b: number;
            /** Null P95 Effect */
            null_p95_effect: number;
            /** Observed Max Effect */
            observed_max_effect: number;
            /** P Value */
            p_value: number | null;
            /** Permutations */
            permutations: number;
            /** Reliable */
            reliable: boolean;
            separability: components["schemas"]["SeparabilityModel"];
            /** Shared */
            shared: boolean[];
            /** Shared Band Names */
            shared_band_names: string[];
            /** Shared Bins */
            shared_bins: components["schemas"]["EffectBinModel"][];
            /** Shared Count */
            shared_count: number;
            /** Shared Fraction */
            shared_fraction: number;
            /** Top Bins */
            top_bins: components["schemas"]["EffectBinModel"][];
        } & {
            [key: string]: unknown;
        };
        /**
         * DeletedRecordingModel
         * @description What a deletion actually removed, so the operator is told rather than reassured.
         */
        DeletedRecordingModel: {
            /** Bytes Freed */
            bytes_freed: number;
        ...
        DiscoveryClassModel: {
            /** Instances */
            instances: components["schemas"]["DiscoveryInstanceModel"][];
            /** Label */
            label: string;
            summary: components["schemas"]["ClassSummaryModel"];
        } & {
            [key: string]: unknown;
        };
        /**
         * DiscoveryInstanceModel
         * @description One instance of a state: what its spectrum looks like, and its opening seconds.
         */
        DiscoveryInstanceModel: {
            /** Bands */
            bands: {
        ...
        DiscoveryModel: {
            /** Analysed Labels */
            analysed_labels: string[];
            /** Channel */
            channel: string;
            /** Channel Ranking */
            channel_ranking: components["schemas"]["ChannelRankModel"][];
            /** Channels */
            channels: string[];
            /** Classes */
            classes: components["schemas"]["DiscoveryClassModel"][];
            comparison: components["schemas"]["ComparisonModel"] | null;
            /** Excluded */
            excluded: components["schemas"]["ExcludedStateModel"][];
            /** Freqs */
            freqs: number[];
            /** Fs */
            fs: number;
        ...
        /**
         * DiscoveryRequest
         * @description Which states to compare, at which electrode, and how hard to test them.
         */
        DiscoveryRequest: {
            /**
             * Channel
        ...
        /**
         * SeparabilityModel
         * @description Leave-one-out nearest-centroid accuracy, with the counts it was computed from.
         */
        SeparabilityModel: {
            /** Accuracy All Bins */
            accuracy_all_bins: number | null;
            /** Accuracy Top Bins */
            accuracy_top_bins: number | null;
            /** Available */
            available: boolean;
            /** Bins Used */
            bins_used: number[];
...
export interface operations {
    ...
    delete_recording_api_recordings__entry_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DeletedRecordingModel"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    discover_api_recordings__entry_id__discovery_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DiscoveryModel"];
                };
            };
            /** @description Validation Error */
            422: {
